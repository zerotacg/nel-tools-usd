...
namespace nel_tools::usd::shape_to_usd::convert::mesh
{
    ...
    VtArray<int> ConverterCMeshMRMSkinned::convertFaceCount(VtArray<int>& source) const
    {
        VtArray<int> target;
    ...
    VtArray<int> ConverterCMeshMRMSkinned::convertFaceIndices(const CIndexBuffer& source, int offset) const
    {
        VtArray<int> target;
    ...
    void ConverterCMeshMRMSkinned::subsets(const SdfPath& root)
    {
    ...
    size_t ConverterCMeshMRMSkinned::subset(const SdfPath& root, uint renderPass, int faceOffset)
    {
